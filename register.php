...
<form id="register" method="post">
    ...
    <div class="mb-3 mt-3">
        ...
        <input type="email" class="form-control" id="email" placeholder="Enter email" name="email" data-validation="required email">
        <div class="error text-danger" id="emailError"></div>
    </div>
    <div class="mb-3">
        <label for="pwd" class="form-label">Password:</label>
        <input type="text" class="form-control" id="pwd" placeholder="Enter password" name="pswd" data-validation="required">
        <div class="error text-danger" id="pswdError"></div>
    </div>
    <div class="mb-3">
        <label for="pwd" class="form-label">Confirm Password:</label>
        <input type="password" class="form-control" id="pswd" placeholder="Enter password" name="repswd" data-validation="required">
        <div class="error text-danger" id="repswdError"></div>
    </div>
    <div class="mb-3">
    ...
    <div class="form-check mb-3">
        ...
        <div class="error text-danger" id="rememberError"></div>
    </div>
